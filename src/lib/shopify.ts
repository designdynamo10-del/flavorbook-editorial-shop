...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "ue2ag3-av.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "7a8a37af9ee9db346f683d37c953d74c";
...
export const productsQueryOptions = (first = 24, query?: string) => ({
